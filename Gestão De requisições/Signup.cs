            ...
            else
            {
               ...
               var contains = "@esmad.ipp.pt";
                ...
                else
                {
                    ...
                    //esse bloco de codigo acrescenta 1 valor sempre que  obcervar que esse id e existente 
                   
                    
                    /*StreamReader sr2 = File.OpenText(hu);
                    while ((li2 = sr2.ReadLine()) != null)
                    {

                        string[] addid = li2.Split(';');

                        if (addid[0]== cont.ToString())
                        {
                            cont++;
                        }
